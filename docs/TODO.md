...
本需求暂无待实施代码项。发布流程与产物见 [v1.8.0](https://github.com/Holden-Lin/claudex-switch/releases/tag/v1.8.0)。
...
- [x] 2026-09-10：新增 `claudex-switch webconfig` 本机网页，批量查看/修改账号配置；Claude 账号支持自定义 env 与子代理/Fable 模型字段。179 项测试 0 失败，浏览器实测两类账号保存均落盘。
